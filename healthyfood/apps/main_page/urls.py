...
urlpatterns = [
    ...
    path('add-to-cart/<str:menu_name>/<str:kkals>', views.AddToCartView.as_view(), name = 'add-to-cart'),
    path('delete-from-cart/<str:menu_name>/<str:kkals>', views.DeleteFromCartView.as_view(), name = 'delete-from-cart'),
    path('change-count/<str:menu_name>/<str:kkals>', views.ChangeCountView.as_view(), name = 'change_count'),
