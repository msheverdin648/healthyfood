# Generated by Django 3.1 on 2020-09-16 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gramm', models.CharField(max_length=20, verbose_name='Диапазон грамм')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.IntegerField(max_length=2, verbose_name='Номер блока')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_products', models.PositiveIntegerField(default=0, verbose_name='Кол-личество продукта')),
                ('final_price', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Общая цена заказа')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_page.customer', verbose_name='Заказчик')),
                ('products', models.ManyToManyField(to='main_page.Order', verbose_name='Заказанные блюда')),
            ],
            options={
